...
const forgotPassword = async (req, res) => {
  ...
  res
    ...
    .json({ msg: "We've sent you a password reset to your email" });
};
...
const resetPassword = async (req, res) => {
  ...
  if (admin) {
    if (
      admin.passwordToken === hashString(token) &&
      admin.passwordTokenExpiryDate > today
    ) {
    ...
    if (
      ...
      user.passwordTokenExpiryDate > today
    ) {
