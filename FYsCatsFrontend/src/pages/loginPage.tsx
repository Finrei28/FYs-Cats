    ...
    >
      {sentEmail ? (
        <form className="login-form" onSubmit={handleResendEmail}>
          ...
          <span onClick={handleLogInReset} className="forget-link">
            Log In
          </span>
        </form>
      ) : !forgetState ? (
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <span className="createAccount">
            ...
            <span className="createAccount-link" onClick={handleCreateAccount}>
              {" "}
              Create one now!
            </span>
          </span>
          <span className="forget-link" onClick={handleForgetState}>
            Forgot Password
          </span>
        </form>
      ) : (
